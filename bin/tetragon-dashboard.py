...
<!-- Top utility row: single-purpose link that doesn't need to crowd the title -->
<div style="display:flex;justify-content:flex-end;align-items:center;padding:6px 16px 0;gap:8px">
